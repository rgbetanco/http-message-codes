...
const ACCOUNT_PASSWORD_EXPIRED = 4;
const ACCOUNT_LOCKED = 8;
...
const AUTHENTICATION_ACCOUNT_PASSWORD_EXPIRED = { r: AUTHENTICATION + ACCOUNT_PASSWORD_EXPIRED, m: "Account password has expired and need to be reset", m_cz: "密碼過期" }
const AUTHENTICATION_ACCOUNT_LOCKED = { r: AUTHENTICATION + ACCOUNT_LOCKED, m: "Account lock for a period of time", m_cz: "登入錯誤, 鎖定中" }
// SERVICE
const SERVICE = 1024
...
module.exports = {
    ...
    AUTHENTICATION_ACCOUNT_PASSWORD_EXPIRED: AUTHENTICATION_ACCOUNT_PASSWORD_EXPIRED,
